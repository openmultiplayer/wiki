...
![Link 'Sunting halaman ini' ada di setiap halaman Wiki](/static/images/contributing/edit-this-page.png)
...
![Tombol Add file](/static/images/contributing/add-new-file.png)
...
![Pratinjau markdown di Visual Studio Code](/static/images/contributing/vscode.png)
