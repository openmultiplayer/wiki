...
Este tutorial se debe utilizar con [GetPlayerColor](../scripting/functions/GetPlayerColor), si no usas [SetPlayerColor](../scripting/functions/SetPlayerColor) En tu script cuando los jugadores se conectan.
