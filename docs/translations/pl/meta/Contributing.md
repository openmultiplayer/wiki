...
![Link „Edit this page” obecny na każdej podstronie wiki](/static/images/contributing/edit-this-page.png)
...
![Przycisk „Add file”](/static/images/contributing/add-new-file.png)
...
![Podgląd markdown w Visual Studio Code](/static/images/contributing/vscode.png)
